...
def ModelSelection3_def():
    ...
    sys_info = {
        ...
        'phiE': {
            ...
            (1, 2): lambda r: MS_interactions(r, 4),
            (2, 1): lambda r: MS_interactions(r, 5),
        ...
        'has_xi': False,
        'has_noise': False,
        'mu0': lambda: MS_init_config(sys_info['d'], sys_info['N'], sys_info['type_info'], 2),
        'T_f': 1,
    }
...
# Example usage:
example_data = ModelSelection3_def()
print(example_data)
